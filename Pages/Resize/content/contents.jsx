...
const Resizercontents = () => {
  return (
    <div>
      <section className="layout-pt-sm layout-pb-sm bg-white">
        <div className="container">
          <div className="row y-gap-48 justify-between order-1 order-lg-1 order-sm-2">
            ...
            <div className="col-xl-6   offset-xl-1 col-md-10 col-lg-6">
              <div className="sectionHeading ">
                ...
                <h2 className="sectionHeading__title">Bulk Image Resizer</h2>
              </div>
              <p className="mt-30 sm:mt-20  lg:pr-0 text-start">
                Meet the 'Bulk Image Resizer' at Image Artisan. Easily resize
                multiple images simultaneously without losing quality with our
                efficient, AI-enhanced tool.
                <br></br>
...
export default Resizercontents;
