          ...
          <div className="row y-gap-48">
            ...
            <div className="col-xl-6 offset-xl-1 col-md-10 col-lg-6">
              ...
              <p className="mt-30 sm:mt-20  lg:pr-0 ">
                Transition from the popular JPG format to various other image
                types using our AI-smart tool. Whether for design work, specific
                platform requirements, or archival purposes, diversify your
                image formats with ease and precision.
              </p>
              <div className="mt-30">
                <Link
        ...
        <div className="container">
          <div className="row y-gap-48 justify-between ">
            <div className="col-xl-6 col-lg-6 col-md-10 order-lg-1 order-2">
              <div className="sectionHeading mt-40 sm:mt-0">
                <h2 className="sectionHeading__title">
                  More free editing
                  <br /> options
                </h2>
...
export default FromJpgContents;
